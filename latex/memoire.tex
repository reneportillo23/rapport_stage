...
\documentclass [twoside,openright,a4paper,11pt,french] {report}
    ...
    \usepackage{float} % pour [H] si tu veux forcer la position des figures
    ...
    \usepackage {hyperref}
    \urlstyle {sf}
    \usepackage{booktabs} % déjà nécessaire pour \toprule etc.
    \usepackage{caption} 
...
\bottomrule
\end{tabular}
\captionof{table}{LightGBM paramètres d'entraînement}
\end{center}
